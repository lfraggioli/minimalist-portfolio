      ...
      <div className="w-full h-auto p-2">
        <div className=" items-center mx-auto justify-center flex">
          ...
          <div className="py-2 px-5 mb-2">
            {title === "Sphera" ? (
              <a
                href="https://www.behance.net/gallery/202880637/Mobile-app-UXUI-case-study"
                target="_blank"
              ...
              >
                <svg
                  ...
                  height="24"
                  fill="white"
                  className="bi bi-behance hover:scale-125 duration-150 transition hover:text-slate-400 bg-slate-700 p-1 rounded-md"
                  viewBox="0 0 16 16"
                >
