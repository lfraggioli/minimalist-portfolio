...
const CVButtonDownload = () => {
  return (
    <div className="justify-start">
      <button className="bg-[#8E6FFE] hover:bg-gradient-to-r hover:from-[#B93BFF] hover:to-[#9C5FFF] active:bg-violet-700 text-md hover:scale-105 duration-300 mt-5 px-4 py-2 rounded-lg">
        <a
